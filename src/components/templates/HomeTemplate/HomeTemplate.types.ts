...
export type HomeTemplateProps = {
  ...
  /** 直近の劇場公開情報（週次まとめ記事）。記事が無い場合は undefined */
  theaterReleaseHighlight?: ReleaseHighlightItem;
  /** 直近のVOD配信情報（週次まとめ記事）。記事が無い場合は undefined */
  vodReleaseHighlight?: ReleaseHighlightItem;
};
