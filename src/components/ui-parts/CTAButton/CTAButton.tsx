...
export const CTAButton = ({ href, fullWidth = false }: Props) => {
  ...
  const className = fullWidth
    ? 'flex h-11 w-full items-center justify-center gap-2 rounded-[8px] bg-[var(--color-primary)] px-4 text-[length:var(--font-size-body-sm)] font-medium tracking-[0.04em] whitespace-nowrap text-[var(--color-text-inverse)] hover:opacity-[0.85]'
