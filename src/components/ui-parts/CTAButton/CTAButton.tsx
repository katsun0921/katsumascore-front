...
export const CTAButton = ({ href, fullWidth = false }: Props) => {
  ...
  const className = fullWidth
    ...
    : 'inline-flex items-center gap-2 rounded-[6px] bg-[var(--color-primary)] px-4 py-2 text-[var(--font-size-ui-lg)] font-medium tracking-[0.04em] whitespace-nowrap text-[var(--color-text-inverse)] hover:opacity-[0.85]'
