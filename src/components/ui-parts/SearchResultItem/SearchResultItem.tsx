  ...
  return (
    ...
    >
      <Link
        ...
        onClick={onClick}
      >
        <span className='min-w-0 flex-1 overflow-hidden text-ellipsis whitespace-nowrap text-[length:var(--font-size-ui-lg)] font-medium'>
          {result.title}
        </span>
        <span className='shrink-0 whitespace-nowrap rounded bg-[var(--color-surface)] px-2 py-1 font-[var(--font-ui)] text-[length:var(--font-size-caption-lg)] text-[var(--color-text-secondary)]'>
          {result.type}
        </span>
      </Link>
    </li>
