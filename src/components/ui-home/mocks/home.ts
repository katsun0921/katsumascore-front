...
export const mockHeroData: HomeHeroProps = {
  slides: [
    ...
    {
      title: 'PAST LIVES',
      copy: '忘れられない記憶と、今を生きる。',
      score: 8.1,
      rank: 'S',
      href: '/posts/past-lives',
      image: 'https://placehold.jp/406040/ffffff/1000x1400.png',
    },
    {
      ...
      score: 7.5,
      rank: 'A',
      href: '/posts/zone-of-interest',
      image: 'https://placehold.jp/704040/ffffff/1000x1400.png',
    },
    {
      title: 'MONSTER',
      copy: '誰もが「怪物」を探している。',
      ...
      rank: 'S',
      href: '/posts/monster',
      image: 'https://placehold.jp/407080/ffffff/1000x1400.png',
    },
    {
      title: 'CLOSE',
      copy: '少年たちの友情と、喪失の物語。',
      ...
      rank: 'A',
      href: '/posts/close',
      image: 'https://placehold.jp/806840/ffffff/1000x1400.png',
    },
    {
      title: 'AFTERSUN',
      copy: '夏の光の中に沈む、父と娘の記憶。',
      score: 8.0,
      rank: 'S',
      href: '/posts/aftersun',
      image: 'https://placehold.jp/408080/ffffff/1000x1400.png',
    },
  ],
};
...
export const mockShortVideoPosts: Post[] = [
  {
    id: '60',
    slug: '/posts/kpop-girls',
    title: 'KPOPガールズ! デーモン・ハンターズ',
