  ...
  if (props.variant === 'cinema') {
    return (
      <div className='mt-[var(--space-32)] flex items-center gap-[var(--space-12)] rounded-[6px] border-l-[4px] border-l-[var(--color-category)] bg-[var(--color-bg-muted)] px-[var(--space-16)] py-[var(--space-12)]'>
        <span className='shrink-0 rounded-[4px] bg-[var(--color-category)] px-[var(--space-12)] py-[var(--space-4)] text-[length:var(--font-size-caption-lg)] font-[var(--font-weight-bold)] text-[var(--color-text-inverse)]'>
          {props.badgeLabel}
        </span>
