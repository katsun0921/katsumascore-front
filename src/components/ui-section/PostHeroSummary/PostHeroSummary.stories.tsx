...
const meta: Meta<typeof PostHeroSummary> = {
  title: 'ui-section/PostHeroSummary',
...
export const DirectionColumnLongText: Story = {
  args: {
    direction: 'column',
    text: '富豪の作家ハーラン・スロンビーが85歳の誕生日パーティーの翌朝、自宅の書斎で死体となって発見される。警察は自殺と断定するが、謎の名探偵ブノワ・ブランが何者かに依頼されて事件を調査し始める。容疑者は一癖も二癖もある家族全員。真相に近づくにつれ、意外な事実が次々と明らかになっていく。アガサ・クリスティーへのオマージュを込めた、どんでん返しに次ぐどんでん返しのミステリー大作。',
  },
}

export const DirectionColumnNoPoster: Story = {
  args: {
    direction: 'column',
    posterUrl: '',
  },
