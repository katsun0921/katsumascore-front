// ISR: revalidate 600s — ドラマカテゴリ記事一覧（/drama, /en/drama）。allPosts は CSR（/api/category-filter-posts）で取得。
...
const DramaIndexPage = ({
  ...
  const { allPosts, isLoading } = useCategoryFilterPosts(WP_DRAMA_CATEGORY_SLUG, loc, CATEGORY_LIST_PER_PAGE);
